...
namespace MantenimientosConMenu.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombres,Apellidos,Numero_Carnet,Carrera,Género")] Alumnos alumnos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombres,Apellidos,Numero_Carnet,Carrera,Género")] Alumnos alumnos)
        {
            if (ModelState.IsValid)
            {
